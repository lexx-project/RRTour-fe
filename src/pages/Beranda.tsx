...
export function Beranda() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <header className="relative min-h-217.5 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            alt="hero image"
            className="w-full h-full object-cover"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDF1BC0kY2CdgpiobEZXE2vN4D_7fyVthwRvnrGhw-wNaxYF9xMDwcCUGsDwbiOafLQStGAk6A3muw3JsFbRnBbV86PXd9VqqN_8jKZgv_hqKxxdOLJp0jHyITXHh67fhQK-u6FV2_3MTYC5io31eeMwKIM7tU_4bJaVUTW8ITpRLHkvDvC4OLIzSq1vyPYDaT1h7vXNQ-uU1fDhldQPpA_XDBS1G3O0ZTrwaWpNb4QJxGXsTHjWcpDajSXenqLL0MCi3nq1dW9OTQ"
          />
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-20">
          <StaggerContainer>
            <h1 className="text-5xl md:text-7xl font-bold font-headline text-on-secondary tracking-tighter mb-6 drop-shadow-lg leading-tight">
              Jelajahi Keindahan
              <br />
              <span className="text-secondary-fixed">Indonesia</span> Bersama
              Kami
            </h1>
            <p className="text-lg md:text-xl text-on-secondary/90 font-body mb-10 max-w-2xl mx-auto font-medium drop-shadow-md">
              Rencanakan liburan impian Anda dengan paket tour terbaik dan
              pelayanan profesional yang dikurasi khusus untuk pengalaman tak
              terlupakan.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/paket-tour"
                className="bg-tertiary-container text-on-primary px-8 py-4 rounded-full font-semibold text-lg hover:bg-tertiary hover:scale-105 transition-all shadow-[0_8px_32px_rgba(25,27,34,0.15)] flex items-center gap-2"
              >
      ...
      <section className="py-24 bg-surface-container-low px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-headline text-on-surface mb-4 tracking-tight">
              Paket Populer Kami
            </h2>
            ...
            <FadeUp delay={0.1}>
              <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_8px_32px_rgba(25,27,34,0.04)] group">
                ...
                <div className="p-8 flex flex-col h-full">
                  ...
                  <p className="text-on-surface-variant font-body mb-6 line-clamp-2">
                    Nikmati keindahan sunrise spektakuler di Penanjakan dan
                    petualangan jeep melintasi lautan pasir berbisik.
                  </p>
            ...
            <FadeUp delay={0.2}>
              <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_8px_32px_rgba(25,27,34,0.04)] group translate-y-4">
                ...
                <div className="p-8 flex flex-col h-full">
                  ...
                  <p className="text-on-surface-variant font-body mb-6 line-clamp-2">
                    Eksplorasi budaya otentik, pantai tersembunyi, dan kuliner
                    lezat pulau dewata secara eksklusif.
                  </p>
                  <div className="flex justify-between items-end border-t border-outline-variant/20 pt-6 mt-auto">
                    <div>
                      <p className="text-sm text-on-surface-variant mb-1">
            ...
            <FadeUp delay={0.3}>
              <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_8px_32px_rgba(25,27,34,0.04)] group">
                ...
                <div className="p-8 flex flex-col h-full">
                  ...
                  <p className="text-on-surface-variant font-body mb-6 line-clamp-2">
                    Sailing trip premium mengunjungi Pulau Padar, bertemu
                    Komodo, dan snorkeling di Pink Beach.
                  </p>
                  <div className="flex justify-between items-end border-t border-outline-variant/20 pt-6 mt-auto">
                    <div>
                      <p className="text-sm text-on-surface-variant mb-1">
            ...
            <FadeUp delay={0}>
              <div className="flex flex-col items-center">
                <motion.div
                  ...
                  className="w-20 h-20 bg-secondary-fixed rounded-full flex items-center justify-center mb-6 text-primary shadow-sm"
                >
                  <span
                ...
                <p className="text-on-surface-variant font-body max-w-xs">
                  Guide lokal berpengalaman yang siap memberikan wawasan
                  mendalam tentang destinasi Anda.
                </p>
              </div>
            </FadeUp>
            <FadeUp delay={0.1}>
              <div className="flex flex-col items-center">
                ...
                <p className="text-on-surface-variant font-body max-w-xs">
                  Paket perjalanan premium dengan nilai terbaik tanpa biaya
                  tersembunyi untuk pengalaman maksimal.
                </p>
              </div>
            </FadeUp>
            <FadeUp delay={0.2}>
              <div className="flex flex-col items-center">
                ...
                <p className="text-on-surface-variant font-body max-w-xs">
                  Keselamatan Anda adalah prioritas kami dengan asuransi
                  perjalanan dan protokol keamanan standar tinggi.
                </p>
              </div>
            </FadeUp>
          </div>
